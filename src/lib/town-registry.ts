...
export const TOWN_REGISTRY: Record<string, TownInfo> = {
  ...
  "alpine": { slug: "alpine", name: "Alpine", neighbors: ["closter", "cresskill", "demarest", "norwood", "tenafly"] },
  "bergenfield": { slug: "bergenfield", name: "Bergenfield", domain: "bergenfield.info", neighbors: ["dumont", "englewood", "new-milford", "teaneck"] },
  "bogota": { slug: "bogota", name: "Bogota", neighbors: ["hackensack", "ridgefield-park", "south-hackensack", "teaneck"] },
  "carlstadt": { slug: "carlstadt", name: "Carlstadt", domain: "carlstadt.info", neighbors: ["east-rutherford", "moonachie", "south-hackensack", "wood-ridge"] },
  ...
  "demarest": { slug: "demarest", name: "Demarest", domain: "demarest.info", neighbors: ["alpine", "closter", "cresskill", "haworth", "tenafly"] },
  ...
  "emerson": { slug: "emerson", name: "Emerson", neighbors: ["hillsdale", "oradell", "park-ridge", "washington-township", "westwood"] },
  ...
  "fair-lawn": { slug: "fair-lawn", name: "Fair Lawn", domain: "fairlawn.info", neighbors: ["elmwood-park", "garfield", "glen-rock", "paramus", "saddle-brook"] },
  "fairview": { slug: "fairview", name: "Fairview", neighbors: ["cliffside-park", "ridgefield"] },
  ...
  "glen-rock": { slug: "glen-rock", name: "Glen Rock", neighbors: ["fair-lawn", "midland-park", "paramus", "ridgewood", "wyckoff"] },
  ...
  "hillsdale": { slug: "hillsdale", name: "Hillsdale", neighbors: ["emerson", "park-ridge", "river-vale", "washington-township", "westwood", "woodcliff-lake"] },
  "ho-ho-kus": { slug: "ho-ho-kus", name: "Ho-Ho-Kus", neighbors: ["allendale", "midland-park", "ridgewood", "saddle-river", "upper-saddle-river", "waldwick"] },
  "leonia": { slug: "leonia", name: "Leonia", domain: "leonia.info", neighbors: ["edgewater", "englewood", "englewood-cliffs", "fort-lee", "palisades-park", "teaneck"] },
  ...
  "lyndhurst": { slug: "lyndhurst", name: "Lyndhurst", domain: "lyndhurst.info", neighbors: ["east-rutherford", "north-arlington", "rutherford"] },
  "mahwah": { slug: "mahwah", name: "Mahwah", domain: "mahwah.info", neighbors: ["allendale", "franklin-lakes", "oakland", "ramsey", "upper-saddle-river"] },
  "maywood": { slug: "maywood", name: "Maywood", domain: "maywood.info", neighbors: ["hackensack", "lodi", "paramus", "rochelle-park", "river-edge"] },
  "midland-park": { slug: "midland-park", name: "Midland Park", neighbors: ["glen-rock", "ho-ho-kus", "ridgewood", "waldwick", "wyckoff"] },
  "montvale": { slug: "montvale", name: "Montvale", domain: "montvale.info", neighbors: ["park-ridge", "upper-saddle-river", "woodcliff-lake"] },
  "moonachie": { slug: "moonachie", name: "Moonachie", domain: "moonachie.info", neighbors: ["carlstadt", "east-rutherford", "hasbrouck-heights", "little-ferry", "south-hackensack", "teterboro", "wood-ridge"] },
  ...
  "old-tappan": { slug: "old-tappan", name: "Old Tappan", neighbors: ["harrington-park", "northvale", "norwood", "river-vale", "rockleigh"] },
  "oradell": { slug: "oradell", name: "Oradell", domain: "oradell.info", neighbors: ["dumont", "emerson", "haworth", "new-milford", "paramus", "river-edge"] },
  ...
  "park-ridge": { slug: "park-ridge", name: "Park Ridge", neighbors: ["emerson", "hillsdale", "montvale", "washington-township", "westwood", "woodcliff-lake"] },
  ...
  "south-hackensack": { slug: "south-hackensack", name: "South Hackensack", neighbors: ["bogota", "carlstadt", "hackensack", "little-ferry", "moonachie", "ridgefield-park", "teterboro", "wallington"] },
  ...
  "upper-saddle-river": { slug: "upper-saddle-river", name: "Upper Saddle River", domain: "uppersaddleriver.info", neighbors: ["allendale", "ho-ho-kus", "mahwah", "montvale", "ramsey", "saddle-river", "waldwick", "woodcliff-lake"] },
  "waldwick": { slug: "waldwick", name: "Waldwick", neighbors: ["allendale", "ho-ho-kus", "midland-park", "ramsey", "ridgewood", "saddle-river", "upper-saddle-river", "wyckoff"] },
